...
Spectrogram_1s = plot_spectrogram(GW_200322_1s, 1/64, 3/256, overlap=2/256, name='GW_200322_1s_')

Spectrogram_120s = plot_spectrogram(GW_200322_120s, 0.1, None, overlap=0.01, name='GW_200322_120s_')

Spectrogram_90m = plot_spectrogram(GW_200322_90m, 1, 0.5, overlap=0.25, name='GW_200322_90m_')

Spectrogram_Chirp = plot_spectrogram(GW_200322_Chirp, 1/32, 1/64, name='GW_200322_Chirp_q_', zoom_low=1268903510.8, zoom_high=1268903511.8, density=True, q=True)

Spec_Chirp = plot_spectrogram(GW200224_Chirp, 1/16, 1/32, overlap=7/256, name='GW200224_Chirp_q_', zoom_low=1266618172, zoom_high=1266618173, density=True, q=True)
