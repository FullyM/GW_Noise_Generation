...
for i in range(30):
    ...
    GW_Noise_q.append(plot_q(GW_Noise[i], name='Test_'+str(i)+'_', q_range=(8, 32)))
...
w = h = int(np.sqrt(pixels))  # should only use quadratic images for which then the square root of number of pixels is int
